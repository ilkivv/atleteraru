...
class CSocServGoogleOAuth extends CSocServAuth
{
	...
	public function getUrl($location = 'opener', $addScope = null, $arParams = array())
	{
		...
		if(IsModuleInstalled('bitrix24') && defined('BX24_HOST_NAME'))
		{
			...
			$backurl = urlencode($GLOBALS["APPLICATION"]->GetCurPageParam('', array("logout", "auth_service_error", "auth_service_id", "backurl"))).'&mode='.$location;
			$state .= urlencode('provider='.static::ID."&backurl=".urlencode($backurl));
		}
		else
		{
