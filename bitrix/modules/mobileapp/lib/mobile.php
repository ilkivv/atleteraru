...
class Mobile
{
	...
	public static $isWebRtcSupported = false;
	 ...
	 * @return boolean
	 */
	public static function isWebRtcSupported()
	{
		return self::$isWebRtcSupported;
	}

	/**
	 * @param boolean $isWebRtcSupported
	 */
	public static function setWebRtcSupport($isWebRtcSupported)
	{
		self::$isWebRtcSupported = $isWebRtcSupported;
	}
	...
	public static function initScripts()
	{
		...
		if (!\Bitrix\Main\IO\File::isFileExists(Application::getDocumentRoot() . $pgJsFile))
		{
	...
	{
		return (Application::isUtfMode() ? $s : $GLOBALS['APPLICATION']->ConvertCharset($s, SITE_CHARSET, 'UTF-8'));
	}
