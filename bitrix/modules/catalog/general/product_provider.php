...
// CHECK THIS RUFUS
			$arPrice = CCatalogProduct::GetOptimalPrice($productID, $quantity, (0 < $intUserID ? $arUserCache[$intUserID] : $USER->GetUserGroupArray()), $renewal, array(CPrice::GetBasePrice($productID)), (0 < $intUserID ? $strSiteID : false), $arCoupons);
			//print_r($arPrice);
			//die();
			if (empty($arPrice))
			{
