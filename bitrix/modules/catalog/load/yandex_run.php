...
/*					$dbVAT = CCatalogProduct::GetVATInfo($arAcc['ID']);
			...
			foreach ($arYandexFields as $key)
			{
				...
				case 'name':
					...
					$strTmpOff .= "<name>".htmlspecialchars(yandex_text2xml($arAcc["NAME"]))."</name>\n";
					break;
				case 'description':
					$strTmpOff .=
						"<description>".
				...
				if (!empty($arCurrentOffer) && !empty($arCurrentPrice))
				{
					...
					foreach ($arYandexFields as $key)
					{
						...
						case 'name':
							...
							$strOfferYandex .= "<name>".htmlspecialchars(yandex_text2xml($arOfferItem["NAME"]))."</name>\n";
							break;
						case 'description':
...
/*						$dbVAT = CCatalogProduct::GetVATInfo($arItem['ID']);
				...
				foreach ($arYandexFields as $key)
				{
					...
					case 'name':
						...
						$strValue = "<name>".htmlspecialchars(yandex_text2xml($arItem["NAME"]))."</name>\n";
						break;
					case 'description':
						$strValue =
							"<description>".
