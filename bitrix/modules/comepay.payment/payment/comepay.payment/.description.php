...
$arPSCorrespondence = array(
		...
		/*
		"CARD_PAYMENT" => array(
				"NAME" => GetMessage("COMEPAY.PAYMENT_CARD_PAYMENT"),
				"DESCR" => "",
				"VALUE" => "0",
				"TYPE" => ""
			),*/
		"CARD_PAYMENT" => array(
			    "NAME" => GetMessage("COMEPAY.PAYMENT_TYPE_PAYMENT"),
			    "DESCR" => "",
			    "VALUE" => array('1' => array('NAME' => GetMessage("COMEPAY.PAYMENT_CARD_PAYMENT")), '0' => array('NAME' => GetMessage("COMEPAY.PAYMENT_COMEPAY_PAYMENT"))),
			    "TYPE" => "SELECT"
			),
		/*
		"TEST" => array(
