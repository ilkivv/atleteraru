...
<div class="carousel-item">
    <div class="j-catalog-item catalog-item" id="<? echo $strMainID; ?>" rel="<?=$arItem['ID']?>" data-value="<?=$arItem['IBLOCK_SECTION_ID'];?>" >
        <a class="catalog-item-block" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>">
            <?
            if ($arItem['PROPERTIES']['CML2_PRICEGROUP']['VALUE']) {
        ...
        <span class="catalog-item-cats">
             ...
             <?php 
            $can_buy = false;
             if (isset($arItem['OFFERS']) &&  !empty($arItem['OFFERS'])  && $arItem['OFFERS_BUY_PROPS'] /*|| $arParams['ALLOW_SALE'] == 'N'*/) {?>
                <div class="choose-taste j-choose-taste <?php if (count($arItem['OFFERS_BUY_PROPS'])<2){echo "no-arrow";}?>">
                    ...
                    <div class="choose-taste-list-container">
                        ...
                        <?php 
            				...
            				{
            				    ?><div class="item" data-value="<?=$property['SKU_ID']?>"><?=$property['VALUE']?> <?php /*?>(<?php if ($property['AMOUNT'] >10){echo ">10";}else{echo $property['AMOUNT'];}?>)<?*/?></div><?php 
            				}
                        ?>
                        </div>
                    </div>
