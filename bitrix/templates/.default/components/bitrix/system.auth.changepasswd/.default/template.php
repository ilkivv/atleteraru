...
//echo "<pre>"; var_dump(htmlspecialchars_decode($arResult["LAST_LOGIN"])); echo "</pre>";
?>
		...
		<tbody>
			<tr>
				...
				<div class="text-field-container ">
                    ...
                    <input type="text" name="USER_LOGIN" maxlength="50" value="<?=urldecode($arResult["LAST_LOGIN"])?>" class="text-field" readonly/>
                </div>
				</td>
			</tr>
			<tr>
				...
				<div class="text-field-container ">
    				...
    				<input type="text" name="USER_CHECKWORD" maxlength="50" value="<?=$arResult["USER_CHECKWORD"]?>" class="text-field" readonly/>
                </div>
				</td>
			</tr>
			<tr>
