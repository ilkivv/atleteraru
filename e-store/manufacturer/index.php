...
$APPLICATION->SetPageProperty("description", "Производители - интернет-магазин Атлет");
$APPLICATION->SetPageProperty("title", "Производители - интернет-магазин Атлет");
...
$arrFilter['PROPERTY_CML2_MANUFACTURER']=$_GET['MANUFACTURER_ID'];?>
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"DETAIL_URL" => "/e-store/#SECTION_CODE_PATH#/#ELEMENT_CODE#/#catalog-brands",
...
$title =  'Купить спортивной питание '.$brand.' по доступным ценам';
$description = 'Доступным цены на спортивное питание '.$brand.' в интернет-магазине Атлет. Купить спортивное питание '.$brand.' с доставкой';
