...
$APPLICATION->SetPageProperty("title", "Распродажа товаров спортивного питания по доступным ценам");
$APPLICATION->SetPageProperty("description", "Распродажа товаров спортивного питания по доступным ценам");
